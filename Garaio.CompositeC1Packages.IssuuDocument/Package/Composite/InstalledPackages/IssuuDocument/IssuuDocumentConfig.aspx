...
<body>
	...
	<form id="Form1" runat="server">
		<ui:page label="<%=Resources.TextResources.IssuuDocument_Configuration_Label %>" image="${icon:tools}">
			...
			<ui:scrollbox id="scrollbox" class="padded flexboxelement">
				<ui:fields>
					<ui:fieldgroup class="first" label="<%=Resources.TextResources.IssuuDocument_Configuration_Label %>">
						<ui:field class="clearfloatelement">
							<ui:fielddesc><%= Resources.TextResources.IssuuDocument_Configuration_APIKey_Label %></ui:fielddesc>
							<ui:fielddata>
								<composite:TextBox runat="server" Type="String" ID="ApiKey" Required="True" />
							</ui:fielddata>
						</ui:field>
						<ui:field class="clearfloatelement">
							<ui:fielddesc><%=Resources.TextResources.IssuuDocument_Configuration_APISecretKey_Label %></ui:fielddesc>
							<ui:fielddata>
								<composite:TextBox runat="server" Type="String" ID="ApiSecretKey" Required="True" />
							</ui:fielddata>
						</ui:field>
						<ui:field class="clearfloatelement">
							<ui:fielddesc><%=Resources.TextResources.IssuuDocument_Configuration_APIURL_Label %></ui:fielddesc>
							<ui:fielddata>
								<composite:TextBox runat="server" Type="String" ID="ApiUrl" Required="True" />
							</ui:fielddata>
						</ui:field>
						<ui:field class="clearfloatelement">
							<ui:fielddesc><%=Resources.TextResources.IssuuDocument_Configuration_RequestsPerSec_Label %></ui:fielddesc>
							<ui:fielddata>
